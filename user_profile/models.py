...
class Grade(models.Model):
    ...
    specialization = models.ForeignKey(
        to=Specialization, on_delete=models.PROTECT, related_name='grades', null=True)
    ...
    def GetGrade(data):
        ...
        if data['grade_letter'] != 'other':
            ...
            if data.get('grade', {}).get('custom_grade_letter') != None:
                ...
                grade.specialization = Specialization.objects.get(
                    name=data['grade']['specialization'])
            grade.save()
            return grade
...
class Profile(models.Model):
    ...
    gender = models.ForeignKey(
        to=Gender, on_delete=models.PROTECT, related_name='users', null=True)
    ...
    def create(data):  # data - json or dict??
        ...
        try:
            profile.gender = Gender.objects.get(
                pk=int(data["profile"].get("gender")))
        except:
            profile.gender = None
...
class Teacher(models.Model):
    ...
    profile = models.ForeignKey(
        Profile, on_delete=models.CASCADE, related_name='teacher')
...
class Student(models.Model):
    ...
    grade = models.ForeignKey(
        to=Grade, on_delete=models.PROTECT, related_name='students', blank=True, null=True)
